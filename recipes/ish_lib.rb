...
# ish:ish_lib recipe
# by Victor Piousbox
# proprietary license (cannot use without written permission). Chances are you don't need to use this file, though contact me if you do.
# Copyright 2013 Wasya.co
#
# Descr: This recipe adds the standalone models and lib
#
